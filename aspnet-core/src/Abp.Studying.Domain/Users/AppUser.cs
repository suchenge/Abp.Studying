...
namespace Abp.Studying.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update StudyingDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update StudyingEfCoreEntityExtensionMappings to extend the IdentityUser entity
